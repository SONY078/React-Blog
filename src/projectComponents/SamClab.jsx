...
export default function SamClab() {
  const [count,setCount] = useState(500);
  const handleClick = ()=>setCount(count+1);
  return (
    <div>
        <h1>How Samsung's C-Lab programme spawns innovation</h1>
        <img src={CLab} alt='Taj Mahal' id='fit-img'/>
        <p id='tparagraph'>
        Over the years, the C-Labs inside programme have spawned 
        innovative Samsung products like its eco-packaging, The Sero Lifestyle TV and even Samsung Pay.
        Class Saathi is as simple as technology can get, but its impact can be way beyond its size. 
        This clicker device from Taghive connects to the smartphone of the teacher and uses an app 
        to give digital assessments of the entire class, thus offering a dashboard for the school 
        administration.
        Taghive was spawned out of C-Labs, Samsung’s in-house incubation programme which selected 
        employee Pankaj Agarwal’s idea and took it to the next level.
        Agarwal is not alone though. Since it started in 2012, this unique startup acceleration 
        programme has seen 1,507 Samsung employees participate in 365 C-Lab projects. About 128 of 
        these projects have been transferred to in-house Samsung divisions, while 59 have spun off 
        into standalone companies. The Korean tech giant has in six years invested $26 million in 
        the 59 C-Lab Inside spin-off startups — 30 
