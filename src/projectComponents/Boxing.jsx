...
export default function Boxing() {
  ...
  return (
    <div>
        <h1>Boxing</h1>
        <img src={Boxi} alt='Taj Mahal' id='fit-img'/>
        <p id='tparagraph'>
        The rumours that hitting a punchbag releases stress and anger is true.
         Finding an outlet for aggression can be both empowering and healing. 
         Short, sharp 'rounds' of punching, followed by rest, results in an intense interval session,
         which releases endorphins.
         If you 'spar' with another boxer you can achieve 'flow', in which you are focussed solely 
         on the task at hand/present moment; a state that everyone from Buddhist monks to Olympic athletes 
         champion.
         Boutique boxing classes are popping up everywhere, but local amateur boxing clubs are also a cost 
         effective way of releasing the rage safely.
         <br/><br/><br/>
